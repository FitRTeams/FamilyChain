...
## Local development
Running `family` local cluster with docker can be done very easily by using provided `scripts` folder
...
## Customization
Use `docker/local/family.sh` script to customize chain parameters.    
