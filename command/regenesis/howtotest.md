...
3) get trie root
```bash
./family regenesis getroot --rpc "http://localhost:10002"
...
./family regenesis --target-path ./trie_new --stateRoot 0xf5ef1a28c82226effb90f4465180ec3469226747818579673f4be929f1cd8663  --source-path ./test-chain-1/trie 
...
```bash
./family polybft-secrets --insecure --data-dir test-chain- --num 4
...
```bash
./family genesis --consensus polybft --validator-set-size=4 --bridge-json-rpc http://127.0.0.1:8545 \
...
```bash
 ./family server --data-dir ./test-chain-1 --chain genesis.json --grpc-address :10000 --libp2p :30301 --jsonrpc :10002 --seal --log-level DEBUG &
./family server --data-dir ./test-chain-2 --chain genesis.json --grpc-address :20000 --libp2p :30302 --jsonrpc :20002 --seal --log-level DEBUG &
./family server --data-dir ./test-chain-3 --chain genesis.json --grpc-address :30000 --libp2p :30303 --jsonrpc :30002 --seal --log-level DEBUG &
./family server --data-dir ./test-chain-4 --chain genesis.json --grpc-address :40000 --libp2p :30304 --jsonrpc :40002 --seal --log-level DEBUG &
wait
...
invalid initial state root
[2]  - exit 1     ./family server --data-dir ./test-chain-2 --chain genesis.json  :20000 
invalid initial state root
[4]  + exit 1     ./family server --data-dir ./test-chain-4 --chain genesis.json  :40000 
```
